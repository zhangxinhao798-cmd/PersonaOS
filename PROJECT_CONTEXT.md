...
- The CLI can discover valid packages under `personas/`.
...
- Manually verify the Chinese-default Web Experience and preserve missing-key validation without coupling language choice to persona identity.
